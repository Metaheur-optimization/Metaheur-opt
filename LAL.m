...
%                 NewBossLionPositionMemory(i,j)=BossLionPositionMemory(i,j)+rand*Hunt_Boss*(BossLionPositionMemory(RandomBossLionIndex(i),j)-BossLionPositionMemory(i,j));
                NewBossLionPositionMemory(i,j)=BossLionPositionMemory(i,j)+((rand*2*Hunt_Boss)-Hunt_Boss)*(BossLionPositionMemory(RandomBossLionIndex(i),j)-BossLionPositionMemory(i,j));
...
%                 end
                while NewBossLionPositionMemory(i,j) < Out.LowerBound(j) || NewBossLionPositionMemory(i,j) > Out.UpperBound(j)
%                     NewBossLionPositionMemory(i,j)=BossLionPositionMemory(i,j)+rand*Hunt_Boss*(BossLionPositionMemory(RandomBossLionIndex(i),j)-BossLionPositionMemory(i,j));
                    NewBossLionPositionMemory(i,j)=BossLionPositionMemory(i,j)+((rand*2*Hunt_Boss)-Hunt_Boss)*(BossLionPositionMemory(RandomBossLionIndex(i),j)-BossLionPositionMemory(i,j));
                end
...
%                 end
        ...
        for ii=1:row
            fitnessMemory=fitness(NewBossLionPositionMemory(:,1:NDecisionVariable),ii,Out); % Fitness evaluation
...
%                 NewSupportLionPositionMemory(s,k)=NewBossLionPositionMemory(randperm(NoofBossLions,1),k)+rand*hunt_support*(NewBossLionPositionMemory(randperm(NoofBossLions,1),k));
                NewSupportLionPositionMemory(s,k)=NewBossLionPositionMemory(randperm(NoofBossLions,1),k)+((rand*2*hunt_support)-hunt_support)*(NewBossLionPositionMemory(randperm(NoofBossLions,1),k));
...
%                 end
                while NewSupportLionPositionMemory(s,k) < Out.LowerBound(k) || NewSupportLionPositionMemory(s,k) > Out.UpperBound(k)
%                     NewSupportLionPositionMemory(s,k)=NewBossLionPositionMemory(randperm(NoofBossLions,1),k)+rand*hunt_support*(NewBossLionPositionMemory(randperm(NoofBossLions,1),k));
                    NewSupportLionPositionMemory(s,k)=NewBossLionPositionMemory(randperm(NoofBossLions,1),k)+((rand*2*hunt_support)-hunt_support)*(NewBossLionPositionMemory(randperm(NoofBossLions,1),k));
                end
...
%         SupportLionPosition=NewSupportLionPositionMemory;
      %P=PlotPositions(iIter,BossLionPosition,SupportLionPosition,NDecisionVariable,NoFuncEval);
        ...
        for ii=1:row
            fitnessMemory=fitness(NewSupportLionPositionMemory(:,1:NDecisionVariable),ii,Out); % Fitness evaluation
